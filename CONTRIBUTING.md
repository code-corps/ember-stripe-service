...
improve documentation or work on any of the features on the wish list.

# Questions

This is the issue tracker for `ember-stripe-service`. The community uses this site
to collect and track bugs and discussions of new features. If you are
having difficulties using `ember-stripe-service` or have a question about usage
...
4. Your issue will be verified. The provided demo will be tested for
   correctness. The ember-stripe-service team will work with you until your issue can be
   verified.

5. Keep up to date with feedback from the ember-stripe-service team on your ticket. Your
...
2. Run the tests. We only take pull requests with passing tests, and it's great
   to know that you have a clean slate: `npm install && ember test`.
